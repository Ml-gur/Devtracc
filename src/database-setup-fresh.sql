-- DevTrack Africa - Fresh Database Setup (Safe for New Projects)
-- This script sets up all necessary tables, triggers, and policies for a clean Supabase project
...
SELECT 'DevTrack Africa fresh database setup completed successfully!' AS status;
